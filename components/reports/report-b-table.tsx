          ...
          >
            <TableHeader>
              <TableRow className="bg-muted/60 [&_th]:sticky [&_th]:top-0 [&_th]:z-10 [&_th]:bg-muted/95 [&_th]:shadow-[0_1px_0_0_hsl(var(--border))]">
                ...
                {wonSaleColumns ? (
                  <>
                    <TableHead className="min-w-[18rem]">تاريخ التعاقد</TableHead>
                    <TableHead className="min-w-[100px]">قيمة البيع</TableHead>
                  </>
                ) : null}
                <TableHead className="min-w-[18rem]">متابعة تالية</TableHead>
                <TableHead className="min-w-[140px]">توصيات الإدارة</TableHead>
                <TableHead className="min-w-[18rem]">تاريخ التوصية</TableHead>
                ...
                <TableHead className="min-w-[18rem]">تاريخ زيارة</TableHead>
                ...
                {Array.from({ length: maxFollowCols }, (_, i) => (
                  <Fragment key={`fh-${i}`}>
                    ...
                    <TableHead className="min-w-[18rem]">تاريخ {i + 1}</TableHead>
                  </Fragment>
                ))}
